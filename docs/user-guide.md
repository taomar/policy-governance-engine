...
### Calling this project from another system

Serving decisions over REST — the three response modes, authentication, request and response shapes, the verification client and the integration test matrix — is covered in the [Integration guide](integration-guide.md).
