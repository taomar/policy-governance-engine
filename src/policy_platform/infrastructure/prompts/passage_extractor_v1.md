...
Source:
    ...
    If the transaction exceeds 50,000, approval from the Finance Director
    is required.
...
Forbidden extraction:
    ...
    Transactions over 50,000 require Finance Director approval.
...
Source:
    ...
    The payment is 5,000.

DO NOT produce:

    Employees with five years of service are eligible for 5,000.
...
DO NOT output:
    ...
    Employees with 5-10 years of service are entitled to 5,000.
